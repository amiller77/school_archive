...
class MastermindTest {
	...
	/**
	 * Test method for {@link MastermindController#getRightColorWrongPlace()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link Mastermind#validateColor(java.lang.String)}.
	 * Test method for {@link Mastermind#validateLength(java.lang.String)}.
	 */
	@Test
	void testOurExceptionClasses() {
		assertThrows(MastermindIllegalColorException.class,() -> {Mastermind.validateColor("voyr");});
		assertThrows(MastermindIllegalColorException.class,() -> {Mastermind.validateColor("oqrg");});
		assertThrows(MastermindIllegalColorException.class,() -> {Mastermind.validateColor("ocgp");});
		assertThrows(MastermindIllegalLengthException.class,() -> {Mastermind.validateLength("goyrp");});
		assertThrows(MastermindIllegalLengthException.class,() -> {Mastermind.validateLength("brp");});
		assertThrows(MastermindIllegalLengthException.class,() -> {Mastermind.validateLength("");});
	}
}