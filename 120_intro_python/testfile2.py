...
class Feature:
    ...
    def width(self):
        """
        Purpose: returns self._width
        Returns: self._width
        """
        return self._width
    def height(self):
        """
        Purpose: returns self._height
        Returns: self._height
        """
        return self._height
    def brick(self):
        """
        Purpose: returns self._brick
        Returns: self._brick
        """
        return self._brick
    def street_pos(self):
        """
        Purpose: returns self._street_pos
...
def x_direction_implementation(x_range,y_range,grid,value):
    """
    Description: stand-alone function or can be use as\
